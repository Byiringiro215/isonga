...
const EventArticlePage = () => {
  ...
  const { selectedEventCard } = useNewsStore()
  const eventId = parseInt(params.id as string)
  
  // Use selected card from store
  const event = selectedEventCard
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center p-4 md:p-7 border-b border-gray-200">
        ...
        <h1 className="text-lg md:text-2xl font-bold text-gray-900">Event Article</h1>
      </div>
      ...
      <div className="px-4 md:px-7 py-6 md:py-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 md:mb-8">
            <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4">{event.title}</h1>
            <div className="flex items-center justify-between text-gray-600 mb-6">
              <div className="text-xs md:text-sm">{event.date}</div>
            </div>
          </div>
